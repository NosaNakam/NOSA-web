...
const Container = styled.div`
  ${tw`relative w-full -mx-8 -mt-8 bg-center bg-cover h-screen min-h-144`}
...
export default ({ heading1, heading2, buttonAction, centerButton }) => {
  return (
    <Container>
      <OpacityOverlay />
      <HeroContainer>
        ...
        <Content>
          ...
          {centerButton && <PrimaryAction>{buttonAction}</PrimaryAction>}
        </Content>
      </HeroContainer>
    </Container>
  );
