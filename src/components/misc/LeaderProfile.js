...
const TestimonialSliderContainer = tw.div`mt-0`;
...
const leaderName = "Rev. J.D. Kundam";
const imageSrc =
  "https://images.unsplash.com/photo-1494790108377-be9c29b29330?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=3.25&w=512&h=512&q=80";
const quote =
  "Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia.";
const customerName = "Steven Marcetti";
const customerTitle = "Event Manager, Brite";
export default () => {
  /*
  ...
  const testimonials = [
    ...
    },
    {
      ...
      customerTitle: "School Principal",
    },
  ];
  return (
    <Container>
      <Content>
        ...
        <TestimonialSliderContainer>
          <Testimonial>
            <ImageContainer>
              <img src={imageSrc} alt={leaderName} />
            </ImageContainer>
            <TextContainer>
              <QuoteContainer>
                <QuotesLeft />
